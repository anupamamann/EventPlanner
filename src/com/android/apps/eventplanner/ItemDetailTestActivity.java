...
public class ItemDetailTestActivity extends FragmentActivity {
		...
		vpPager.setAdapter(adapterViewPager);
		 ...
		 vpPager.setOnPageChangeListener(new OnPageChangeListener() {
	        	...
	        	public void onPageSelected(int position) {
	        		Toast.makeText(ItemDetailTestActivity.this,"Selected page position: " + position, Toast.LENGTH_SHORT).show();
	        	}
		 ...
		 btAdd.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Toast.makeText(ItemDetailTestActivity.this, selectedFood.getFood().getUrls().toString(), Toast.LENGTH_LONG).show();
				}
			});
